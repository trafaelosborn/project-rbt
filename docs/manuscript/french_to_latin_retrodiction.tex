...
All source code, manuscript source, and lightweight analysis artifacts
supporting this study are publicly available at
\url{https://github.com/trafaelosborn/project-rbt} and archived at Zenodo
under DOI \href{https://doi.org/10.5281/zenodo.20330397}{10.5281/zenodo.20330397}.
The Zenodo deposit additionally includes the Latin token reference file
(\path{data/sequestered/latin/latin_tokens.json}), which exceeds GitHub's
per-file size limit and is therefore distributed exclusively through Zenodo.
No restrictions apply to access or reuse beyond the terms of the MIT
license under which the repository is released.
